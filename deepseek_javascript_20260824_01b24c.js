// Snakeeyes Simkl Addon — Using keyword search for all new franchises
...
// ── TMDB catalog map - USING KEYWORD SEARCH FOR NEW FRANCHISES ──────────────
const tmdbCatalogMap = {
    ...
    // NEW FRANCHISES - USING KEYWORD SEARCH (more reliable)
...
function buildManifest(userKey) {
    return {
        ...
        catalogs: [
            ...
            // NEW FRANCHISES - Using keyword search
...
async function searchByKeyword(keyword) {
    ...
    // Get the first matching keyword ID
