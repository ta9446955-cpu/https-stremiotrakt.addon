...
const tmdbCatalogMap = {
    ...
    // Franchises - using TMDB collection IDs for accuracy
    'tmdb-marvel':           'discover/movie?with_companies=420&sort_by=release_date.asc',
    'tmdb-dc':               'discover/movie?with_companies=429&sort_by=release_date.asc',
    'tmdb-starwars':         'discover/movie?with_collection=10&sort_by=release_date.asc',
    'tmdb-lotr':             'discover/movie?with_collection=119&sort_by=release_date.asc',
    'tmdb-harrypotter':      'discover/movie?with_collection=1241&sort_by=release_date.asc',
    'tmdb-jurassicpark':     'discover/movie?with_collection=328&sort_by=release_date.asc',
    // Directors
