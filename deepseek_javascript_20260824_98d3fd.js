// Snakeeyes Simkl Addon — All horror franchises added
...
// ── TMDB catalog map - ALL HORROR FRANCHISES ADDED ──────────────────────────
const tmdbCatalogMap = {
    ...
    // Franchises - EXISTING (Using collection)
    ...
    // Franchises - NEW (Using keyword search)
    'tmdb-johnwick':         { endpoint: 'keyword', params: 'John Wick', type: 'keyword' },
    'tmdb-predator':         { endpoint: 'keyword', params: 'Predator', type: 'keyword' },
    'tmdb-friday13':         { endpoint: 'keyword', params: 'Friday the 13th', type: 'keyword' },
    'tmdb-nightmareelm':     { endpoint: 'keyword', params: 'Nightmare on Elm Street', type: 'keyword' },
    'tmdb-godzilla':         { endpoint: 'keyword', params: 'Godzilla', type: 'keyword' },
    'tmdb-fastfurious':      { endpoint: 'keyword', params: 'Fast and Furious', type: 'keyword' },
    
    // NEW HORROR FRANCHISES - ADDED
    'tmdb-conjuring':        { endpoint: 'collection', params: '374651', type: 'collection' },  // The Conjuring Universe
    'tmdb-halloween':        { endpoint: 'collection', params: '761', type: 'collection' },     // Halloween Collection
    'tmdb-scream':           { endpoint: 'collection', params: '107382', type: 'collection' },  // Scream Collection
    'tmdb-saw':              { endpoint: 'collection', params: '18128', type: 'collection' },   // Saw Collection
    'tmdb-insidious':        { endpoint: 'collection', params: '238212', type: 'collection' },  // Insidious Collection
    'tmdb-purge':            { endpoint: 'collection', params: '338431', type: 'collection' },  // The Purge Collection
    'tmdb-paranormal':       { endpoint: 'collection', params: '27295', type: 'collection' },   // Paranormal Activity Collection
    'tmdb-chucky':           { endpoint: 'collection', params: '460635', type: 'collection' },  // Child's Play/Chucky Collection
    'tmdb-texaschainsaw':    { endpoint: 'collection', params: '23665', type: 'collection' },   // Texas Chainsaw Massacre Collection
...
function buildManifest(userKey) {
    return {
        ...
        catalogs: [
            ...
            // NEW HORROR FRANCHISES
            { type: 'movie',  id: 'tmdb-conjuring',          name: '👻 The Conjuring Universe' },
            { type: 'movie',  id: 'tmdb-halloween',          name: '🎃 Halloween Collection' },
            { type: 'movie',  id: 'tmdb-scream',             name: '📞 Scream Collection' },
            { type: 'movie',  id: 'tmdb-saw',                name: '🧩 Saw Collection' },
            { type: 'movie',  id: 'tmdb-insidious',          name: '🚪 Insidious Collection' },
            { type: 'movie',  id: 'tmdb-purge',              name: '🔴 The Purge Collection' },
            { type: 'movie',  id: 'tmdb-paranormal',         name: '📹 Paranormal Activity Collection' },
            { type: 'movie',  id: 'tmdb-chucky',             name: '🔪 Chucky Collection' },
...
app.get('/:userKey/catalog/:type/:catalogId.json', async (req, res) => {
    ...
    if (tmdbCatalogMap[catalogId]) {
        try {
            const { endpoint, params } = tmdbCatalogMap[catalogId];
            const cacheKey = `${userKey}-${catalogId}`;
            const metas = await tmdbFetch(endpoint, params, type, cacheKey);
